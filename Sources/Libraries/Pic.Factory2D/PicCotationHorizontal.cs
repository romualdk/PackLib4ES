    ...
    namespace Factory2D
    {
        public class PicCotationHorizontal : PicCotationDistance
        {
            ...
            protected override void DrawArrowLine(PicGraphics graphics, Vector2D pt2, Vector2D pt3, double textWidth, double textHeight, out Vector2D ptText, out bool middle)
            {
                ...
                middle = length > textWidth * GlobalCotationProperties.LengthCoef;
                ...
                { 
                    ...
                    ptText =  pt2 + (pt3 - pt2) * ((GlobalCotationProperties.LengthCoef*length + 0.5*textWidth) / length);
                }
            }
            ...
            {
                return ECode.PE_COTATIONHORIZONTAL;
            }
            #endregion
            ...
            protected override bool IsMiddleQuotation(Vector2D pt2, Vector2D pt3, double textWidth, double textHeight)
            {
