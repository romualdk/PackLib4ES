...
namespace Pic.Factory2D
{
    ...
    public class PicToolArea : PicTool
    {
        ...
        public override void ProcessFactory(PicFactory factory)
        {
            ...
            int maxSeg = Properties.Settings.Default.AreaMaxNoSegments;
            ...
            for (int i = 0; i < iNoStep; ++i)
            {
                ...
                if (nby > 1 && (nby % 2 != 0))
                {
                    ...
                    {
                        Area = Area + stepCurrent * (tabyh[l + 1] - tabyh[l]);
                    }
                }
            }
        }
        ...
        public static int MaxNoSegments => Properties.Settings.Default.AreaMaxNoSegments;
        #endregion
