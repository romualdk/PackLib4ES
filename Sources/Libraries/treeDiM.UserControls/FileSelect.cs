namespace treeDiM.UserControls
{
    ...
    */
    ...
    public class FileSelect : UserControl, INotifyPropertyChanged
    {
        ...
        private readonly BrowseButton btn = new BrowseButton();
        public FileSelect()
        {
            CreateTextBox();
            base.AllowDrop = true;
            file.FileChanged += OnFileNameChanged;
            EnabledChanged += OnEnabledChanged;
        }

        private void OnEnabledChanged(object sender, EventArgs e) => Invalidate(true);
        ...
        /// 
        public FileDialog FileDialog => fd ?? (fd = savemode ? (FileDialog) new SaveFileDialog() : new OpenFileDialog());
        ...
        private const int DefaultHeightSingle = 20;
        private const int DefaultHeightMulti = 60;
        ...
        class BrowseButton : Button
        {
            ...
            protected override Size DefaultSize => new Size(18, 18);
        ...
        #endregion
        #region Appearance
        protected override Size DefaultSize => new Size(200, DefaultHeightSingle);
        ...
        private bool ShouldSerializeBorderStyle() => BorderStyle != defaultBorderStyle;
