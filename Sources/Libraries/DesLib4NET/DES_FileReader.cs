...
namespace DesLib4NET
{
    public class DES_FileReader : IDisposable
    {
        ...
        #region Read methods
        public bool ReadFile(Stream fs, DES_CreationAdapter creationAdapter)
        {
            if (null != _listener)
                _listener.Begin();
        ...
        public bool ReadFile(string filePath, DES_CreationAdapter creationAdapter)
        {
            ...
            return ReadFile( File.Open(filePath, FileMode.Open), creationAdapter);
        }
