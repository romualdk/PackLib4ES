...
namespace Pic.Plugin.GeneratorCtrl
{
    public partial class FindAndReplaceForm : Form
	{
		...
		public bool ReplaceMode
		{
			...
			set {
				bnReplace.Visible = btnReplaceAll.Visible = value;
				lblReplaceWith.Visible = txtReplaceWith.Visible = value;
				btnHighlightAll.Visible = !value;
				AcceptButton = value ? bnReplace : btnFindNext;
				UpdateTitleBar();
			}
		}

		private void OnBnClickFindPrevious(object sender, EventArgs e)
		{
			FindNext(false, true, "Text not found");
		}
		private void OnBnClickFindNext(object sender, EventArgs e)
		{
		...
		private void OnBnClickHighlightAll(object sender, EventArgs e)
		{
		...
		private void OnFormClocsing(object sender, FormClosingEventArgs e)
		...
		private void OnBnClickReplace(object sender, EventArgs e)
		{
		...
		private void OnBnClickReplaceAll(object sender, EventArgs e)
		{
			int count = 0;
